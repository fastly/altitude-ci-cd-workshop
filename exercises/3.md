...
For convience, and to avoid you having to type or copy your token, we've included a shell script named `travis-encrypt.sh` in the project directory which will run the `travis encrypt` command for all of your needed environment variables.
